...
if(NOT NVParsers_LIBRARY)
    foreach(search ${_TensorRT_SEARCHES})
        find_library(NVParsers_LIBRARY NAMES nvparsers ${${search}} PATH_SUFFIXES lib)
    endforeach()
endif()

if(NOT NVInferPlugin_LIBRARY)
    foreach(search ${_TensorRT_SEARCHES})
        find_library(NVInferPlugin_LIBRARY NAMES nvinfer_plugin ${${search}} PATH_SUFFIXES lib)
    endforeach()
endif()
...
if(TensorRT_FOUND)
    ...
    if(NOT TensorRT_LIBRARIES)
        ...
        if (NVParsers_LIBRARY)
            list(APPEND TensorRT_LIBRARIES ${NVParsers_LIBRARY})
        endif()
        if (NVInferPlugin_LIBRARY)
            list(APPEND TensorRT_LIBRARIES ${NVInferPlugin_LIBRARY})
        endif()
        if (NVONNXParser_LIBRARY)
            list(APPEND TensorRT_LIBRARIES ${NVONNXParser_LIBRARY})
        endif()
    endif()
