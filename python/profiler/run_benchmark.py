...
# CUDAProfileParser,
PARSER_KLASSES = [PythonProfileParser, PythonProfileTotalParser, CUDASQLiteParser, TFProfParser, CombinedProfileParser, PlotSummary, TimeBreakdownPlot, CategoryOverlapPlot]
